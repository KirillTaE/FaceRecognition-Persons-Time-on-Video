...
if len(sys.argv) <= 1:
    ...
    print("data_path = 'data.pt'")
    print("input_video_path = 'zoom_1.mp4'")
    print("input_photo_catalog_path = 'photos'")
    print("input_output_video_path = 'zoom_1_new.mp4'")
    input()
elif len(sys.argv) != 8:
    print("Wrong number of args. Please, input:")
    print("doVideo = <boolean>")
    print("updateData = <boolean>")
    print("data_path = <string>")
    print("input_video_path = <string>")
    print("input_photo_catalog_path = <string>")
    print("input_output_video_path = <string>")
else:'''
...
while True:
    ...
    if web_cam or doVideo:
        ...
        if web_cam:
            cv.imshow('da', cv.resize(image, [720, 405]))
